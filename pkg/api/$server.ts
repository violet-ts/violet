...
// prettier-ignore
import controllerFn5 from './api/browser/projects/_projectId/desks/_deskId/controller'
// prettier-ignore
import controllerFn6 from './api/browser/works/controller'
// prettier-ignore
import controllerFn7 from './api/browser/works/_workId@string/controller'
// prettier-ignore
import controllerFn8 from './api/browser/works/_workId@string/revisions/controller'
// prettier-ignore
import controllerFn9 from './api/browser/works/_workId@string/revisions/signedUrl/controller'
// prettier-ignore
import controllerFn10 from './api/browser/works/_workId@string/revisions/_revisionId@string/controller'
// prettier-ignore
import controllerFn11 from './api/browser/works/_workId@string/revisions/_revisionId@string/messages/controller'
// prettier-ignore
import controllerFn12 from './api/browser/works/_workId@string/revisions/_revisionId@string/messages/_messageId@string/controller'
// prettier-ignore
import controllerFn13 from './api/browser/works/_workId@string/revisions/_revisionId@string/messages/_messageId@string/replies/controller'
// prettier-ignore
import controllerFn14 from './api/browser/works/_workId@string/revisions/_revisionId@string/_messageId@string/controller'
// prettier-ignore
import controllerFn15 from './api/browser/works/_workId@string/revisions/_revisionId@string/_messageId@string/replies/controller'
// prettier-ignore
import controllerFn16 from './api/healthz/controller'
// prettier-ignore
import controllerFn17 from './api/tasks/controller'
// prettier-ignore
import controllerFn18 from './api/tasks/_taskId@number/controller'
// prettier-ignore
...
export default (fastify: FastifyInstance, options: FrourioOptions = {}) => {
  ...
  const controller18 = controllerFn18(fastify)
  ...
  fastify.post(`${basePath}/browser/projects/:projectId/desks/:deskId`, asyncMethodToHandler(controller5.post))

  fastify.get(`${basePath}/browser/works`, methodToHandler(controller6.get))

  fastify.get(`${basePath}/browser/works/:workId`, methodToHandler(controller7.get))

  fastify.get(`${basePath}/browser/works/:workId/revisions`, asyncMethodToHandler(controller8.get))
  ...
  fastify.post(`${basePath}/browser/works/:workId/revisions/signedUrl`, asyncMethodToHandler(controller9.post))

  fastify.get(`${basePath}/browser/works/:workId/revisions/:revisionId`, asyncMethodToHandler(controller10.get))

  fastify.post(`${basePath}/browser/works/:workId/revisions/:revisionId`, asyncMethodToHandler(controller10.post))

  fastify.get(`${basePath}/browser/works/:workId/revisions/:revisionId/messages`, asyncMethodToHandler(controller11.get))

  fastify.get(`${basePath}/browser/works/:workId/revisions/:revisionId/messages/:messageId`, methodToHandler(controller12.get))

  fastify.post(`${basePath}/browser/works/:workId/revisions/:revisionId/messages/:messageId/replies`, asyncMethodToHandler(controller13.post))

  fastify.get(`${basePath}/browser/works/:workId/revisions/:revisionId/:messageId`, methodToHandler(controller14.get))

  fastify.get(`${basePath}/browser/works/:workId/revisions/:revisionId/:messageId/replies`, methodToHandler(controller15.get))

  fastify.get(`${basePath}/healthz`, methodToHandler(controller16.get))
  ...
  fastify.get(
    ...
    asyncMethodToHandler(controller17.get)
  )

  fastify.post(`${basePath}/tasks`, asyncMethodToHandler(controller17.post))
  ...
  fastify.patch(
    ...
    asyncMethodToHandler(controller18.patch)
  )
  ...
  fastify.delete(
    ...
    asyncMethodToHandler(controller18.delete)
  )
